class PopularAdvertisementModel {
  ...
  PopularAdvertisementModel({this.status, this.code, this.msg, this.data});

  PopularAdvertisementModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    code = json['code'];
    msg = json['msg'];
    if (json['data'] != null) {
...
class PopularAdsList {
  ...
  PopularAdsList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
